...
public class VentanaPrincipal extends JFrame {
	...
	private static JTable DFTable = new JTable(modeloDF){  
	 ...
	 /*private static JTable AtTable = new JTable(modeloAt){  
		      public boolean isCellEditable(int row, int column){  
		    	  return false;  
		        }
	...
	static int yi = 0;
	private final JLabel UDFJC = new JLabel("    Universidad Distrital Francisco Jos\u00E9 de Caldas - Maestr\u00EDa Ciencias de la Informaci\u00F3n y las Comunicaciones -  Bases de Datos");
	...
	Graphics g;
	static int ct;
	static Funciones DpendenciasF = new Funciones();
	...
	public VentanaPrincipal() {
		...
		textArea.setBounds(374, 68, 349, 227);
		...
		btnClaves.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				textArea.append("Conjunto de superclaves:\n");
				Arreglos sk = DpendenciasF.bruteKeys(DpendenciasF);
			    textArea.append(sk.toString() + "\n");

			    textArea.append("Conjunto de claves candidatas:\n");
			    Arreglos cc = DpendenciasF.candKeys(DpendenciasF);
			    textArea.append(cc.toString() + "\n");
	...
	public static void PonerTextoDF(String Izq, String Der) {
	    ...
	    Arreglos y = new Arreglos();
	    StringTokenizer depI = new StringTokenizer(Izq, ",");
	    StringTokenizer depD = new StringTokenizer(Der, ",");
	        while(depI.hasMoreTokens()) {
	          x.add(depI.nextToken());
	          }
	        while(depD.hasMoreTokens()) {
		          y.add(depD.nextToken());
		          }
	        Dependencias d = new Dependencias(x, y);
	        DpendenciasF.add(d);
	        System.out.println("Se agregó "+ DpendenciasF.xAts());
	        }
